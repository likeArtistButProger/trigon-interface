            ...
            <div className="flex flex-row justify-end mt-3 md:mt-3 md:mr-3">
...

                {
                    ...
                    <div onClick={this.logout} id="logout" className="pl-2 pr-1 border-2 border-trigon_gray-300 rounded-lg cursor-pointer">
                        <svg className="mt-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#979797" viewBox="0 0 24 24"><path d="M16 9v-4l8 7-8 7v-4h-8v-6h8zm-16-7v20h14v-2h-12v-16h12v-2h-14z"/></svg>
